...
def get_project_normative_parameters(
    ...
    try:
        ...
        stage_config_dir = f"backend/projects/{project_name}/normativas"
...
def initialize_stage_normative(project_name: str, circuit_type: str, base_normative: str) -> bool:
    ...
    try:
        ...
        stage_file = f"backend/projects/{project_name}/normativas/{circuit_type}.yaml"
...
def load_base_normative_full(normative: str) -> dict:
    ...
    try:
        ...
        config_file = "backend/configs/normativas.yaml"
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                override_file = f"backend/projects/{project_name}/norm_overrides.json"
